...
-- Hosts
INSERT INTO USERS (id_admin, id_role, id_address, firstname, lastname, phone, email, password_hash, is_deleted) VALUES
                                                                                                                    (1, 2, 3, 'Thomas', 'Martin', '0611223344', 'thomas.host1@example.com', '$2a$12$.98', TRUE),
...
(1, 'Studio Moderne Lyon 2ème', 'Studio rénové de 30m², idéal pour étudiants ou jeunes actifs.', FALSE, 65.00, 'asset/images/estates/lyon_studio1/photo.jpg', 8, 3),
